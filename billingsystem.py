...
class Bill_App:
    def __init__(self, root):
        ...
        bg_color = "#badc57"
        title = Label(self.root, text="Billing Software", font=('times new roman', 30, 'bold'), pady=2, bd=12, bg="#FF0000", fg="White", relief=GROOVE)
        title.pack(fill=X)
        ...
        clear_btn = Button(btn_f, command=self.clear_data, text="Clear", bg="#FF0000", bd=2, fg="white", pady=15, width=12, font='arial 13 bold')
        clear_btn.grid(row=0, column=2, padx=5, pady=5)

        exit_btn = Button(btn_f, command=self.exit_app, text="Exit", bd=2, bg="#FF0000", fg="white", pady=15, width=12, font='arial 13 bold')
